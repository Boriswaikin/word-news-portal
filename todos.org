...
[]- move chatGPT function to bookmarks
[]- add link to chatGPT history in detail page
[]- display chatGPT in chatGPT page(get), allow user to save history(post)
[]- responsive design
[]- testing 2-3
[]- accessibility 2 snapshots
